...
To evaluate the collective behaviour of the network, we analyse the cross-correlation of $L_2$ displacements across all layers using a trinity of metrics: Pearson (linear), Spearman (rank-monotonic), and Distance Correlation (non-linear). The resulting heatmaps (Figure \ref{fig:correlations}) provide strong empirical evidence for a dynamical bifurcation between the input-adjacent and terminal regions of the architecture.
